class RangeSlider {
  ...
  constructor(container = {}, options = {}) {
    ...
    // validation. the only required argument.
    if (!container || (container.nodeName !== 'DIV' && container.tagName !== 'DIV')) return;
    ...
    handleLeft.className = 'range-slider__handle range-slider__left-handle';
    this.UI.handleLeft = handleLeft;
    this.UI.slider.appendChild(this.UI.handleLeft);

    // right handle
    const handleRight = document.createElement('div');
    handleRight.className = 'range-slider__handle range-slider__right-handle';
    ...
    fill.className = 'range-slider__rail-fill';
    this.UI.fill = fill;
  ...
  starting(event = null) {
    ...
    this.UI.fill.classList.remove('range-slider-transition');
    this.UI.handleLeft.classList.remove('range-slider-transition');
    this.UI.handleRight.classList.remove('range-slider-transition');
  ...
  move(data, preventPublish) {
    ...
    this.UI.fill.classList.add('range-slider-transition');
    this.UI.handleLeft.classList.add('range-slider-transition');
    this.UI.handleRight.classList.add('range-slider-transition');
  ...
  disable(boolean) {
    ...
    if (this.isDisabled) {
      this.UI.slider.classList.add('range-slider--disabled');
    } else {
      this.UI.slider.classList.remove('range-slider--disabled');
    }
  }
